    ...
    return (
        <>
                ...
                <div className="container_nav_bar_of_header_2">
                    ...
                    {isSearchOpen ? (
                        ...
                        <ul className="hidden sm:flex items-center gap-6 md:gap-8 d-flex">
                            <li><Link activeStyle to="/" className="relative after:block after:absolute after:-bottom-[5px] after:w-full after:h-px after:bg-current after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:origin-right hover:after:origin-left">Home</Link></li>
                            <li><Link activeStyle to="/store" className="relative after:block after:absolute after:-bottom-[5px] after:w-full after:h-px after:bg-current after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:origin-right hover:after:origin-left">Store</Link></li>
                            <li><Link activeStyle to="/services" className="relative after:block after:absolute after:-bottom-[5px] after:w-full after:h-px after:bg-current after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:origin-right hover:after:origin-left">Service</Link></li>
                            <li><Link activeStyle to="/shape" className="relative after:block after:absolute after:-bottom-[5px] after:w-full after:h-px after:bg-current after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:origin-right hover:after:origin-left">Shape</Link></li>
                            <li><Link activeStyle to="/contact" className="relative after:block after:absolute after:-bottom-[5px] after:w-full after:h-px after:bg-current after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:origin-right hover:after:origin-left">Contact</Link></li>
                        </ul>
                    ...
                    {isSearchOpen ? null : (
                        ...
                        <li>
                            <div className="account-menu">
                                ...
                                <div className={`account-menu-content ${isSidebarOpen ? 'open' : ''}`}>
                                    <Link to='/login'><button className="login-button">Login</button></Link>
                                    <hr className="separator" />
                                    <ul>
                                        {/* <li><Link to="/about" className="drawer-link">About</Link></li> */}
                                        {/* <li><Link to="/services" className="drawer-link">Services</Link></li> */}
                                        <Link to="/contact" className="drawer-item">About Us</Link><br />
                                        <Link to="/contact" className="drawer-item">Contact</Link><br />
                                        <button className="logout-btn drawer-link">Logout</button>
                                    </ul>
                                </div>
                            </div>
            ...
            <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
                ...
                {/* Checkout button */}
                <Link action to='/Checkout'><button className="checkout-btn">Checkout</button></Link>
