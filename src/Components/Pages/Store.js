            ...
            <div className="container-fluid">
                <div className="row px-xl-5">
                    <div className="col-lg-8">
                        <div id="my-carousel" className="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                            <ol className="carousel-indicators custom-indicators">
                                {carouselItems.map((item, index) => (
                                    <li key={index} onClick={() => handleSlideChange(index)} className={index === activeIndex ? 'active' : ''}></li>
                                ))}
                            </ol>
                                    ...
                                    <div key={index} className={`carousel-item position-relative ${index === activeIndex ? 'active' : ''}`} style={{ height: '430px' }}>
                                        ...
                                        <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                            <div className="carousel-content p-3" style={{ maxWidth: '700px' }}>
                                                <h1 className="carousel-title text-white mb-3 animate__animated animate__bounceInDown">{item.name}</h1>
                                                <p className="carousel-description mx-md-5 px-5 animate__animated animate__fadeInUp">{item.description}</p>
                                                <p className="carousel-price text-white mb-0">{item.price}</p>
                    ...
                    <div className="col-lg-4">
                        ...
                        <div className="custom-product-offer mb-30" style={{ height: '200px' }}>
